...
description: "Use when the list should split self-serve from sales-led companies, or when an offer needs anchoring against a prospect's published price points, read from their own pricing page. Also use when a pricing_public boolean is needed as a filter."
license: MIT
