...
| Column | Type | Notes |
|---|---|---|
| `email` | string | Must be valid email. Script does not re-verify (use [`/list-quality-scorecard`](../../list-quality-scorecard/SKILL.md) or MillionVerifier first). |
| `first_name` | string | Used in `{{first_name}}` merge |
| `last_name` | string | Used in `{{last_name}}` merge |
| `company_name` | string | Used in `{{company_name}}` merge. NOTE: [`/campaign-copywriting`](../../campaign-copywriting/SKILL.md) requires `{{company_name}}`, never `{{company}}`. |
...
| `situation_line` | AI-generated per-lead specific observation (output of [`/personalization-subagent-pattern`](../../personalization-subagent-pattern/SKILL.md) or [`/campaign-copywriting`](../../campaign-copywriting/SKILL.md)) |
...
Run [`/list-quality-scorecard`](../../list-quality-scorecard/SKILL.md) first. Confirm:
