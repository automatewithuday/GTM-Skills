...
description: "Use when the list should be people who liked or commented on a competitor's or customer's LinkedIn posts, with source-company exclusions and a DNC list. Also use when raw engager exports need filtering down to the roughly 1-in-10 that fit the ICP."
license: MIT
