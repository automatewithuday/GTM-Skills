...
1. **Smartlead Smart Delivery spam test** ([`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) → `run-spam-test.ts`)
...
2. **Check domain authentication** ([`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) → `check-domain-auth.ts`)
   - Missing DKIM on any domain → fix immediately (see [`/zapmail-domain-setup-public`](../zapmail-domain-setup-public/SKILL.md) for reconnect steps)
   - DMARC policy=reject with alignment failures → temporarily lower to quarantine

3. **Check warmup status** ([`/smartlead-inbox-manager`](../smartlead-inbox-manager/SKILL.md) → `list-health.ts`)
...
4. **Check bounce rate** ([`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) → `audit-performance.ts`)
...
Check:
- Spamhaus, Barracuda, SURBL via [`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) → spam-test report → blacklist detail
...
- **If you replace:** archive the old domain, buy a new lookalike via [`/zapmail-domain-setup-public`](../zapmail-domain-setup-public/SKILL.md), warm it for 2 weeks before reusing.
...
### Step 3: Retire workflow (via [`/smartlead-inbox-manager`](../smartlead-inbox-manager/SKILL.md))
...
2. **Audit:** run [`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) full suite
...
Meanwhile: continue the weekly rhythm via [`/cold-email-weekly-rhythm`](../cold-email-weekly-rhythm/SKILL.md), which catches new issues as they emerge.
...
- [`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) — the diagnostic suite you run first
- [`/smartlead-inbox-manager`](../smartlead-inbox-manager/SKILL.md) — tag, rotate, retire inboxes
- [`/zapmail-domain-setup-public`](../zapmail-domain-setup-public/SKILL.md) — replace a burned domain
- [`/positive-reply-scoring`](../positive-reply-scoring/SKILL.md) — confirm recovery (reply rate back to baseline)
