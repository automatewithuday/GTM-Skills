...
description: "Use when targeting companies growing a specific department (sales, marketing) in the last 6 months, or when a hiring_surge_line is needed with role-start counts as evidence. Also use when headcount growth should be a list filter, not just copy."
license: MIT
