...
description: "Use when the greeting uses the prospect's first name and the raw field is broken: honorifics, emoji, job titles, all-caps, appended hiring notices. Also use when \"Hi Dr MATTHEW\" is showing up in previews."
license: MIT
