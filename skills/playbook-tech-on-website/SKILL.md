...
description: "Use when targeting by technology installed on the prospect's website (Shopify, HubSpot, WordPress, Klaviyo) and technographic vendor claims need verifying against the live site. Also use when a tech_confirmed flag should gate the list."
license: MIT
