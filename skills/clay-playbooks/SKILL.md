---
name: clay-playbooks
description: "Use when building or running any of the signal playbooks in Clay, either as a browser-built table or a CLI-built workflow, and the shared conventions, credit gates, and build harnesses are needed. Also use as the index to pick which playbook produces which field."
license: MIT
