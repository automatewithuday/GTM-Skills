---
name: icp-onboarding
description: "Use when starting a new cold email engagement or client and the ICP, offer, hard filters, soft preferences, and banned industries have not been written down yet. Produces the client-profile.yaml that campaign-strategy and list-building skills consume. Also use when a website is the only input available."
license: MIT
...
10. **Lead magnet — what can you legally give away for free?** (If they don't have one, invoke [`/lead-magnet-brainstorm`](../lead-magnet-brainstorm/SKILL.md) skill.)
...
With `client-profile.yaml` in hand, the user's next skill is [`/cold-email-starter-kit`](../cold-email-starter-kit/SKILL.md) (manual first campaign) or [`/auto-research-public`](../auto-research-public/SKILL.md) (automated daily campaigns).
