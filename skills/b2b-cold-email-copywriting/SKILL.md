...
description: "Use when writing or fixing cold email that has to land in the primary inbox and get replies at volume — a cold sequence for an enriched list, outbound copy for a new offer, or a campaign getting no replies. Covers the Big-3 diagnosis order (list, offer, copy), deliverability prerequisites, five email frameworks, the personalisation ladder, interest-based CTAs, the follow-up arc, deliverability-safe spintax, banned words, and a pre-send QA checklist. Also use when copy is being blamed for a list or offer problem, or when a draft asks for a meeting or drops a link in email one."
license: MIT
metadata:
...
- [spam-word-checker](../spam-word-checker/SKILL.md) to scan a finished draft against section 9.
- [smartlead-spintax](../smartlead-spintax/SKILL.md) to apply section 8 at upload time.
- [campaign-copywriting](../campaign-copywriting/SKILL.md) for the stepwise direction, subject, body, YAML flow.
- [email-deliverability-audit](../email-deliverability-audit/SKILL.md) when section 1 is the real problem.
