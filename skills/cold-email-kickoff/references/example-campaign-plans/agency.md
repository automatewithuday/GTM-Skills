...
While you wait:
1. Run [`/prospeo-full-export`](../../../prospeo-full-export/SKILL.md) → pull ~1,500 agency founders (titles + industries above)
2. [`/icp-prompt-builder`](../../../icp-prompt-builder/SKILL.md) → qualify (filter out SaaS-adjacent, too-small, too-large agencies)
3. [`/list-quality-scorecard`](../../../list-quality-scorecard/SKILL.md) → grade
4. Have list ready + iced in `profiles/scale-studio/list.csv`

Then:
1. Wait 5 more days for inbox warmup to complete (2 full weeks)
2. [`/campaign-copywriting`](../../../campaign-copywriting/SKILL.md) → write Campaign #1 (Agency Capacity Pressure Signal)
4. [`/smartlead-campaign-upload-public`](../../../smartlead-campaign-upload-public/SKILL.md)
5. 21 days → [`/positive-reply-scoring`](../../../positive-reply-scoring/SKILL.md)

**Or:** go set up [`/cold-email-weekly-rhythm`](../../../cold-email-weekly-rhythm/SKILL.md) on your calendar now so you don't forget the weekly ops once live.
