...
Recommended flow:
1. [`/google-maps-list-builder`](../../../google-maps-list-builder/SKILL.md) → scrape 1,000 multi-location restaurants in top 50 metros with 100+ reviews + 4+ stars
2. [`/icp-prompt-builder`](../../../icp-prompt-builder/SKILL.md) (required) → qualify a 50-sample (filter out chains, single-locations, 3-star places)
3. [`/blitz-list-builder`](../../../blitz-list-builder/SKILL.md) → find owner contacts at each remaining restaurant
4. `/email-waterfall` → fill missing emails
5. [`/list-quality-scorecard`](../../../list-quality-scorecard/SKILL.md) → grade
6. [`/campaign-copywriting`](../../../campaign-copywriting/SKILL.md) → write Campaign #1 (Google Review Signal)
8. [`/smartlead-campaign-upload-public`](../../../smartlead-campaign-upload-public/SKILL.md) → DRAFT, review, Start manually
9. 21 days → [`/positive-reply-scoring`](../../../positive-reply-scoring/SKILL.md)
