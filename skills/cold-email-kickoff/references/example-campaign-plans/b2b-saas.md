...
Recommended: [`/prospeo-full-export`](../../../prospeo-full-export/SKILL.md) (title-first, best fit for VP Product ICP).

Flow from here:
1. [`/prospeo-full-export`](../../../prospeo-full-export/SKILL.md) → pull ~2,000 VP/Head of Product leads in Software Development industry
2. [`/icp-prompt-builder`](../../../icp-prompt-builder/SKILL.md) (required step inside Prospeo skill) → qualify on a 50-sample before scaling
3. [`/list-quality-scorecard`](../../../list-quality-scorecard/SKILL.md) → grade the filtered list
4. [`/campaign-copywriting`](../../../campaign-copywriting/SKILL.md) → write the "Analytics Stack Audit" campaign (Campaign #1 from strategy)
6. [`/smartlead-campaign-upload-public`](../../../smartlead-campaign-upload-public/SKILL.md) → DRAFT upload, review in UI, hit Start
7. Wait 21 days, then [`/positive-reply-scoring`](../../../positive-reply-scoring/SKILL.md)
