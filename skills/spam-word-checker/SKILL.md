...
**If flags cleared:** run [`/smartlead-spintax`](../smartlead-spintax/SKILL.md) before upload, then launch via [`/smartlead-campaign-upload-public`](../smartlead-campaign-upload-public/SKILL.md).

**If flags fired:** back to [`/campaign-copywriting`](../campaign-copywriting/SKILL.md) to rewrite the flagged lines. Re-run this check after.
...
- [`/campaign-copywriting`](../campaign-copywriting/SKILL.md) — produces the copy this skill screens
