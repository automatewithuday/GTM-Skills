...
description: "Use when a campaign needs a new_in_role_line on every row: prospects who recently took their seat (0-6 months) and are rebuilding their vendor stack. Also use when tenure precision matters and LinkedIn headline freshness is in doubt."
license: MIT
