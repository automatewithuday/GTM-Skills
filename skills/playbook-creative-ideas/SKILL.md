...
description: "Use when the email premise is \"I looked at your business and had three ideas\" and the three idea slots must be operator-defined, not free-form. Also use when creative-ideas copy is suggesting things the seller cannot deliver."
license: MIT
