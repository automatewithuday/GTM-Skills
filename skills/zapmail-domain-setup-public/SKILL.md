...
**Run [`/smartlead-inbox-manager`](../smartlead-inbox-manager/SKILL.md)** to configure warmup + signatures + tags on your newly-created inboxes.
...
**During the 2-week wait:** build your list ([`/prospeo-full-export`](../prospeo-full-export/SKILL.md), [`/disco-like`](../disco-like/SKILL.md), etc.), write copy ([`/campaign-copywriting`](../campaign-copywriting/SKILL.md)). You'll be ready to launch the moment warmup finishes.

## Related skills

- [`/smartlead-inbox-manager`](../smartlead-inbox-manager/SKILL.md) — configure the inboxes you just provisioned
- [`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) — check auth records (SPF/DKIM/DMARC) after setup
- [`/cold-email-kickoff`](../cold-email-kickoff/SKILL.md) — the orchestrator that usually invokes this skill
