...
description: "Use when managing Smartlead inboxes at scale: enabling or disabling warmup with correct ramp settings, bulk-setting signatures, tagging inboxes active vs insurance, or checking inbox health. Also use right after new inboxes arrive from zapmail-domain-setup-public."
license: MIT
...
**If inboxes are already warm:** proceed to list-building ([`/prospeo-full-export`](../prospeo-full-export/SKILL.md), [`/disco-like`](../disco-like/SKILL.md), etc.) using `active`-tagged inboxes.
...
- [`/zapmail-domain-setup-public`](../zapmail-domain-setup-public/SKILL.md) — creates the inboxes this skill configures
- [`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) — when health dashboard shows problems
- [`/smartlead-api`](../smartlead-api/SKILL.md) — underlying API reference
