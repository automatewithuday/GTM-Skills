...
description: "Use when building a list around one flagship customer or case study by decomposing why it resonates (industry, headcount, keywords) and filtering lookalikes with a model judge. Also use when \"more companies like our best customer\" is the brief."
license: MIT
