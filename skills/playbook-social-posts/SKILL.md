...
description: "Use when the opening line should reference one recent post from the prospect or their company page, with a skip filter for personal, political, or charged content. Also use when campaigns need proof of research without deep manual reading."
license: MIT
