...
description: "Use when the opener should reference a named customer the prospect publishes on their site (case studies, customer stories), with a verbatim quote as proof. Also use when investor or press logos are being mistaken for customers."
license: MIT
