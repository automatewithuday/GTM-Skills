...
description: "Use when a campaign needs each company's verified official social profile URLs (LinkedIn, X, Facebook, Instagram, YouTube, TikTok) from a domain. Also use before engagement scraping or ad-library lookups that need the right page."
license: MIT
