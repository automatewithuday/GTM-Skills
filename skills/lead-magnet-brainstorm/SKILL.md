...
- During [`/icp-onboarding`](../icp-onboarding/SKILL.md) when the user can't answer the "what can you give away" question
...
With a lead magnet chosen, the user's next skill is [`/cold-email-starter-kit`](../cold-email-starter-kit/SKILL.md) references `03-campaign-copywriting.md` to write the email that delivers the magnet.
