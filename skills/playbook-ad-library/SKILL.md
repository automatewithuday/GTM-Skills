...
description: "Use when targeting companies currently running Meta (Facebook/Instagram) ads, or when an ad_library_line describing one live offer is needed on every row. Also use when the domain-to-Facebook-page mapping is the hard part."
license: MIT
