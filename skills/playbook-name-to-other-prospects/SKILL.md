...
description: "Use when the email should ask \"is this you or someone else\" by naming two senior colleagues at the prospect's company. Also use when a redirect CTA or wrong-person handling needs real names on every row."
license: MIT
