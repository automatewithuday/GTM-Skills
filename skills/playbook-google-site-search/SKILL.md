...
description: "Use when a list should be filtered by whether each company's website mentions a keyword, phrase, or certification, using a site: search per domain. Also use when a site_keyword_line is needed as evidence."
license: MIT
