...
description: "Use when the offer is generic and each email needs one sentence naming what the seller would actually do for this specific company, drawn from homepage evidence. Also use when AI personalization reads as filler."
license: MIT
