...
description: "Use when the opener should come from a real connection: prospects who used to work at a current customer or case-study company, share an investor, metro, or event. Also use when a warm_intro_line needs evidence attached to every row."
license: MIT
