...
- When [`/auto-research-public`](../auto-research-public/SKILL.md) or similar orchestration skills need parallel personalization
...
**This is a pattern doc, not a standalone skill.** It's invoked by [`/auto-research-public`](../auto-research-public/SKILL.md) and [`/campaign-copywriting`](../campaign-copywriting/SKILL.md) when they need per-lead personalization at scale.
...
- [`/auto-research-public`](../auto-research-public/SKILL.md) — the primary consumer of this pattern
- [`/icp-onboarding`](../icp-onboarding/SKILL.md) — produces the `client-profile.yaml` the prompt pulls from
- [`/cold-email-starter-kit`](../cold-email-starter-kit/SKILL.md) references `03-campaign-copywriting.md` for copy principles the prompt enforces
