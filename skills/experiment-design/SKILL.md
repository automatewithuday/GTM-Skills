...
Before running any experiment, confirm your baseline is healthy: **overall reply rate ≥1% after 200+ sends.** If your baseline is below 1% after 200 sends, the problem isn't your experiment — your infrastructure or copy is already broken. Run [`/email-deliverability-audit`](../email-deliverability-audit/SKILL.md) first.
...
Pull metrics via [`/positive-reply-scoring`](../positive-reply-scoring/SKILL.md) skill:
- Total sent (per arm)
...
- [`/positive-reply-scoring`](../positive-reply-scoring/SKILL.md) skill — how to actually measure the outcome

---

## What to do next

**Launch the planned experiment** via [`/smartlead-campaign-upload-public`](../smartlead-campaign-upload-public/SKILL.md) (manual) or [`/auto-research-public`](../auto-research-public/SKILL.md) (automated). Use the `variants.yaml` from [`/campaign-copywriting`](../campaign-copywriting/SKILL.md).

**Then wait 21 days** before evaluating — reply rate needs that long to stabilize. After 21 days, [`/positive-reply-scoring`](../positive-reply-scoring/SKILL.md) on each arm.

**Or wait:** if you don't have 2,000+ leads per experiment arm, you can't detect normal-sized effects. Build a bigger list ([`/prospeo-full-export`](../prospeo-full-export/SKILL.md), [`/disco-like`](../disco-like/SKILL.md)) first.

## Related skills

- [`/campaign-copywriting`](../campaign-copywriting/SKILL.md) — produces the copy variants this experiment tests
- [`/smartlead-campaign-upload-public`](../smartlead-campaign-upload-public/SKILL.md) — launches each arm
- [`/positive-reply-scoring`](../positive-reply-scoring/SKILL.md) — measures the outcome after 21 days
