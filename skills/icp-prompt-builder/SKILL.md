...
Claude asks the user (or reads `client-profile.yaml` from [`/icp-onboarding`](../icp-onboarding/SKILL.md)):
...
1. [`/icp-onboarding`](../icp-onboarding/SKILL.md) → produce `client-profile.yaml`
2. [`/disco-like`](../disco-like/SKILL.md) OR [`/blitz-list-builder`](../blitz-list-builder/SKILL.md) OR [`/prospeo-full-export`](../prospeo-full-export/SKILL.md) → pull a sample of 50-100 companies
3. [`/icp-prompt-builder`](../icp-prompt-builder/SKILL.md) → tune qualification prompt on that sample (3-5 rounds typical)
...
6. [`/blitz-list-builder`](../blitz-list-builder/SKILL.md) or `/email-waterfall` on the qualified subset
...
**Apply the tuned prompt to your full list** (the list-building skill you came from — Prospeo, Blitz, DiscoLike, Google Maps, or Competitor Engagers — will walk through this). Then [`/list-quality-scorecard`](../list-quality-scorecard/SKILL.md) to grade the filtered output.
...
- [`/icp-onboarding`](../icp-onboarding/SKILL.md) — run FIRST to produce client-profile.yaml
- [`/disco-like`](../disco-like/SKILL.md), [`/blitz-list-builder`](../blitz-list-builder/SKILL.md), [`/google-maps-list-builder`](../google-maps-list-builder/SKILL.md), [`/prospeo-full-export`](../prospeo-full-export/SKILL.md) — pull the companies this skill qualifies
- [`/personalization-subagent-pattern`](../personalization-subagent-pattern/SKILL.md) — same approval-loop pattern, applied to copy personalization
