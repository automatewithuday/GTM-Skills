...
description: "Use when the list should be companies that raised an equity round in the last 12 months, or when a funding_line is needed on every row. Also use when funding data must abstain (empty string) rather than guess."
license: MIT
