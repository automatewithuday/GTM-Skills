...
**Launch the spintaxed copy** via [`/smartlead-campaign-upload-public`](../smartlead-campaign-upload-public/SKILL.md) — the spintax gets embedded in the `variants.yaml` body fields and renders per-recipient on send.

**Or wait:** skip this skill until your copy is final. Spintax complicates later debugging.

## Related skills

- [`/campaign-copywriting`](../campaign-copywriting/SKILL.md) — writes the base copy this skill varies
- [`/smartlead-campaign-upload-public`](../smartlead-campaign-upload-public/SKILL.md) — launches the spintaxed campaign
