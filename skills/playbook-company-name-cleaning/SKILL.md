...
description: "Use when copy names the prospect's company and the raw field is messy (legal suffixes, taglines, dba entities, ALL CAPS). Also use when mail-merge output reads like \"Irby Utilities, LLC\" instead of \"Irby\"."
license: MIT
